...
/// These are the main statments that make up the conversation.
  ...
  question = 'How old are you?';			    	// load next question
      ...
      if(input<30) {
	answer = 'You are so young! Some snakes are as old as 30 :-)';
	waitTime = 3000;
	question = 'Where do you live?';
      }
      else {
	answer = 'You are older than the oldest snakes!';
	waitTime = 3000;
	question = 'Where do you live?';
      }
  }
  ...
  question = 'Is it warm in ' + input + '?';
	...
	question = 'Is it warm there?';
       ...
       answer= 'Cool! Adding some ' + input+' to this app.';
    ...
    if(input.toLowerCase()==='yes'|| input===1){
      answer = 'Perfect!';
      waitTime =2000;
      question = 'Any parting words for your snake friends?';
    }
    else if(input.toLowerCase()==='no'|| input===0){
  ...
  // load next question
    ...
    answer= 'Noted. Goodbye!';// output response
    waitTime =0;
    question = '';
  }
